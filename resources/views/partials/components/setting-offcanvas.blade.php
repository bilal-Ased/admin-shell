        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div data-value="theme-color-default" data-info="#079aa2" data-setting="color-mode1"
                ...
                <div class="grid-cols-5 mb-4 d-grid gap-x-2">
                    <div class="btn-border bg-transparent active" data-value="theme-color-blue" data-info="#573BFF"
                    ...
                    <div class="btn-border bg-transparent active" data-value="theme-color-gray" data-info="#FD8D00"
                        data-setting="color-mode1" data-name="color" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="btn-border bg-transparent active" data-value="theme-color-red" data-info="#366AF0"
                    ...
                    <div class="btn-border bg-transparent active" data-value="theme-color-yellow" data-info="#6410F1"
                        data-setting="color-mode1" data-name="color" data-bs-toggle="tooltip"
                    ...
                    <div class="btn-border bg-transparent active" data-value="theme-color-pink" data-info="#25C799"
                        data-setting="color-mode1" data-name="color" data-bs-toggle="tooltip"
                ...
                <div class="d-grid gap-x-3 grid-cols-2 mb-4">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <img src="{{ asset('images/settings/light/08.png') }}" alt="pill-one-side"
                            class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar"
                            data-name="sidebar-item" data-value="navs-pill">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <img src="{{ asset('images/settings/light/09.png') }}" alt="pill-all"
                            class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar"
                            data-name="sidebar-item" data-value="navs-pill-all">
