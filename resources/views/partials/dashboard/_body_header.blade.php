    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item me-3">
        ...
        <li class="nav-item dropdown">
          ...
          <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->username) }}&background=0D8ABC&color=fff" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
          <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->username) }}&background=0D8ABC&color=fff" alt="User-Profile" class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
