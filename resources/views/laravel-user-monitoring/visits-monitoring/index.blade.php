            ...
            <tbody>
                @foreach ($visits as $visit)
                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                        ...
                        <td class="pl-24">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm leading-none text-gray-600 ml-2">
                                    {{ $visit->user->username ?? 'Guest User' }}
                                </p>
                            </div>
                        </td>
                        <td class="pl-5">
                        ...
                        <td class="pl-5">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30"
                                    viewBox="0 0 50 50">
                                    <path
                                        d="M 46 4.867188 L 4 10.117188 L 4 39.882813 L 46 45.132813 Z M 44 7.132813 L 44 24 L 25 24 L 25 9.507813 Z M 23 9.757813 L 23 24 L 6 24 L 6 11.882813 Z M 6 26 L 23 26 L 23 40.242188 L 6 38.117188 Z M 25 26 L 44 26 L 44 42.867188 L 25 40.492188 Z">
                                    </path>
                                </svg>
                                <p class="text-sm leading-none text-gray-600 ml-2">
                                    {{ $visit->platform }}
                        ...
                        <td class="pl-5">
                            <button
                                class="py-3 px-3 text-sm focus:outline-none leading-none text-blue-700 bg-blue-100 rounded">
                                {{ $visit->created_at->format('Y-m-d H:i') }}
                            </button>
                        </td>
                        <td class="pl-4">
                            <form method="post"
                                action="{{ route('user-monitoring.visits-monitoring-delete', $visit->id) }}">
                                @csrf
                                @method('DELETE')

                                <button
                                    class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-red-600 py-3 px-5 bg-red-100 rounded hover:bg-red-200 focus:outline-none"
                                    type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
