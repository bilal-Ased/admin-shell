<div class="col">
    <div class="card page-bg card-block card-stretch card-height">
        <div class="card-body">
            <svg class="mb-3" width="50" height="50" viewBox="0 0 54 54" fill="none"
            ...
            <x-landing-pages.widgets.features featurTitle="Software Development"
                featurText="We create reliable, scalable, and secure software for any platform, combining industry expertise with the latest IT advancements to deliver custom solutions tailored to your users' needs.." />
        </div>
    </div>
</div>
<div class="col">
    <div class="card page-bg card-block card-stretch card-height">
        <div class="card-body">
            <svg class="mb-3" width="50" height="50" viewBox="0 0 44 54" fill="none"
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path
            ...
            <x-landing-pages.widgets.features featurTitle="Software Testing"
                featurText="
We offer comprehensive QA and testing outsourcing services, including QA process enhancement and TCoE setup. Our end-to-end testing covers mobile, web, and desktop applications." />
        </div>
    </div>
</div>
<div class="col">
    <div class="card page-bg card-block card-stretch card-height">
        <div class="card-body">
            <svg class="mb-3" width="50" height="50" viewBox="0 0 64 64" fill="none"
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path opacity="0.4"
            ...
            <x-landing-pages.widgets.features featurTitle="IT Consulting"
...
<div class="col">
    <div class="card page-bg card-block card-stretch card-height">
        <div class="card-body">
            ...
            <x-landing-pages.widgets.features featurTitle="Flexibility"
                featurText="Lorem ipsum dolor sit amet, consectetur adipiscing elit." />
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            <svg class="mb-3" width="50" height="50" viewBox="0 0 64 64" fill="none"
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    fill="#3A57E8"></path>
                <ellipse opacity="0.4" cx="51.9997" cy="11.9999" rx="6.66667" ry="6.66667" fill="#3A57E8">
                </ellipse>
            </svg>
            <x-landing-pages.widgets.features featurTitle="Portability"
                featurText="Lorem ipsum dolor sit amet, consectetur adipiscing elit." />
        </div>
    </div>
</div>
<div class="col">
    <div class="card page-bg card-block card-stretch card-height">
        <div class="card-body">
            ...
            <x-landing-pages.widgets.features featurTitle="Funtionality"
                featurText="Lorem ipsum dolor sit amet, consectetur adipiscing elit." />
        </div>
    </div>
</div>
