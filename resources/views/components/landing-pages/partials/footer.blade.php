            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-md-0 mt-4">
                    ...
                    <ul class="list-unstyled p-0 m-0 d-flex mt-4">
                        <li>
                            <a href="#"><img src="{{ asset('images/landing-pages/images/brands/08.webp') }}"
                                    alt="fb" loading="lazy" class="rounded-pill"></a>
                        </li>
                        <li class="ps-3">
                            <a href="#"><img src="{{ asset('images/landing-pages/images/brands/09.webp') }}"
                                    alt="gm" loading="lazy" class="rounded-pill"></a>
                        </li>
                        <li class="ps-3">
                            <a href="#"><img src="{{ asset('images/landing-pages/images/brands/10.webp') }}"
                                    alt="im" loading="lazy" class="rounded-pill"></a>
                        </li>
                        <li class="ps-3">
                            <a href="#"><img src="{{ asset('images/landing-pages/images/brands/13.webp') }}"
                                    alt="li" loading="lazy" class="rounded-pill"></a>
                        </li>
                    </ul>
                </div>
                <hr>
