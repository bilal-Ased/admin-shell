<nav class="navbar navbar-expand-md navbar-light main-nav">
    <div class="container-fluid navbar-inner">
        ...
        <div class="offcanvas-lg offcanvas-end header-one" tabindex="-1" id="offcanvasResponsive"
            aria-labelledby="offcanvasResponsiveLabel">
            <ul class=" navbar-nav iq-nav-menu list-unstyled">
                <li class="nav-item">
                    <a class="nav-link menu-arrow justify-content-start" href="#" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="homeData">Home</a>
                    <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                        ...
                        <li class="nav-item"><a class="nav-link {{ activeRoute(route('landing-pages.ecommerce')) }}"
