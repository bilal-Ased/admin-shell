                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            ...
                            <!-- Modal -->
                            <!-- Your index file -->
                            <div class="modal fade" id="addAppointmentStatusModal" tabindex="-1"
                                aria-labelledby="addAppointmentStatusModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="addAppointmentStatusModalLabel">Add Status</h5>
