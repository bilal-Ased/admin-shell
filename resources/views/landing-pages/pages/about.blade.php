<x-app-layout layout="landing" :isHeader1=true>
    <x-landing-pages.widgets.sub-header subTitle="About Us" subBreadcrume="About Us" />
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <h2 class=" mb-4">Get <span class="text-primary">Unique <br>Solutions</span> With Us!</h2>
                </div>
                <div class="col-md-6">
                    <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum ac integer
                        semper sit
                    ...
                    <a hrer="#" class="btn btn-primary mt-4">Know More</a>
                </div>
                <div class="col-md-8 mb-3 mt-4 mt-md-0">
                    <img src="{{ asset('images/landing-pages/images/home-4/banner-left.webp') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col-md-4 mb-3">
                    <img src="{{ asset('images/landing-pages/images/home-4/banner-right.webp') }}" alt=""
                        class="img-fluid ">
                </div>
                ...
                <div class="col-md-4">
                    <div class="card  mb-lg-0">
                        <div class="card-body">
                            <h4 class="mb-2">Our Strategies</h4>
                            <p class="mb-0">
                                It Is A Long Established Fact That A Reader Will Be Distracted By The Readable Content
                                Of A
                                Page When Looking At Its Layout.
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <h2 class=" mb-4 text-white">Services <span class="text-primary">We Offer</span></h2>
                    <p class="mb-0">It is a long established fact that a reader will be distracted by the readable
                        content
                        of a page when looking at its layout. </p>
                    <a hrer="#" class="btn btn-primary mt-4">Know More</a>
                    <img src="{{ asset('images/landing-pages/images/home-4/service.webp') }}" alt=""
                ...
                <div class="col-md-6">
                    <div class="row  row-cols-1 row-cols-lg-2">
                        ...
                        <div class="col">
                            <div class="card services-box mb-lg-0  rounded-1">
                                <div class="card-body">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <h2 class=" mb-4">We Make <span class="text-primary">Your <br>Idea Come True</span></h2>
                    <p class="mb-4">Orci ipsum tempus amet libero turpis enim sed quis. Maecenas suspendisse ac
                        integer
