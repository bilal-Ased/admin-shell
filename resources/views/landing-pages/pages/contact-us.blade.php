                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card rounded-1 mb-lg-0">
                        <div class="card-body text-center">
                            ...
                            <p class="mt-3">Nairobi Kenya</p>
                            <p class="mt-3">United Kingdom</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-1 mb-lg-0">
                        <div class="card-body text-center">
                            ...
                            <p class="mt-3">mughalbilal89@gmail.com</p>
                            <p class="mt-3">mohammedmusa@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-1 mb-lg-0">
                        <div class="card-body text-center">
                            ...
                            <p class="mt-3">+254797686905</p>
                            <p class="mt-3">+44 7469 283288</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img src="{{asset('images/landing-pages/images/home-4/contact.webp')}}" alt="" class="img-fluid"
                        loading="lazy">
                </div>
                <div class="col-md-6 mt-4 mt-md-0">
                    <form action="{{ route('feedback.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="full-name" name="name" placeholder="Your Name"
                                required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="customCheck1" name="agree_terms"
                                required>
                            <label class="form-check-label" for="customCheck1">By Clicking You Agree To Use Our “Form”
