                ...
                <div class="col-md-4 mt-md-0 mt-4">
                    ...
                    <form action="{{ route('subscribe') }}" method="post">
                        ...
                        <div class="input-group mb-4">
                            <input type="email" name="email" class="form-control input-email ps-0" placeholder="Your Email"
                                aria-label="Your Email" aria-describedby="basic-addon1" required>
                                <span type="submit" class="input-group-text input-email-btn"></span>
                            </span>
                        </div>
                    </form>
